 % Add paths where the model functions are located, e.g., the spm_fx_lfp model and
 % respective priors
...
% Adjust the relative path below if executing from a different location.
 ...
 addpath('spm12/spm12/toolbox/Neural_Models');
 addpath('DIP_DCM_25') % path where this folder is stored
